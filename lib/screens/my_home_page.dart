              ...
              child: Container(
                child: Padding(
                  padding: EdgeInsets.only(
                      top: screenHeight * 0.03, bottom: screenHeight * 0.15),
                  child: Center(
                    child: Text(
                      "Easy English BD",
                      style: TextStyle(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => EasyTranslator()));
                        },
                        child: Padding(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.white,
                                border: Border.all(
                                    width: 1, color: Color(0xff0a7e8c)),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => EnglishGrammar()));
                            },
                            child: Container(
                              height: screenHeight * 0.09,
                              width: screenWidth * 0.44,
